...
public final class Share {
    ...
    public static final String KEY_ITS_ADDRESS ="its_address";
    public static final String KEY_ITS_PORT ="its_port";
    public static final String KEY_VIDEO_ADDRESS ="video_address";
