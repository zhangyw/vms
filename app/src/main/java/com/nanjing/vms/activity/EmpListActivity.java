 ...
 * Version 1.0
 */
public class EmpListActivity extends BaseTitleActivity {
    ...
    private void initView() {
        setTitle("人员列表", "添加", NO_RES_ID);
        setBtnRightTextOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(EmpListActivity.this, EmpEditActivity.class);
        ...
        findViewById(R.id.layout_search).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(EmpListActivity.this, EmpSearchListActivity.class);
                startActivity(intent);
            }
        });
    ...
    private void initListView() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (emp != null) {
                    Intent intent = new Intent(EmpListActivity.this, EmpDetailsActivity.class);
        ...
        loadMoreListViewContainer.setLoadMoreHandler(new LoadMoreHandler() {
            ...
            public void onLoadMore(LoadMoreContainer loadMoreContainer) {
                loadData(mEmps.get(mEmps.size() - 1).getEmpID(), null);
            }
        });
    ...
    private void loadData(final String last_id, String keyword) {
        ...
        mCall = RetrofitClient.vmsApis().list_emps(RequestParameters
