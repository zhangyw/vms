 ...
 * Version 1.0
 */
public class VehicleBlackListActivity extends BaseTitleActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vehicle_black_list);
        initView();
        initListView();
        autoLoadData();
    ...
    private void initListView() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (item != null) {
                    Intent intent = new Intent(VehicleBlackListActivity.this, VehicleDetailsActivity.class);
    ...
    private void loadData(final String last_id, String keyword) {
        ...
        mCall = RetrofitClient.vmsApis().list_black_vehicles(access_token);
