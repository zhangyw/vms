package com.hik.data;

import android.content.Context;
import android.content.SharedPreferences;

import com.nanjing.vms.VmsApp;
...
//    private static final String DEF_SERVER       = "http://172.10.38.8:82";
    private static final String DEF_SERVER       = "http://172.1.15.21:80";
    

    private Config() {
        sp = VmsApp.getIns().getSharedPreferences(CONFIG_FILE_NAME, Context.MODE_PRIVATE);
    }
